...
def main():
    ...
    algorithm_choice = 'BnB'  # Example, can loop over different algorithms
    cut_off_time =600  # Example cutoff time in seconds
    ...
    for i in range(1, 22):  # Assuming files are named small_1 to small_10
        ...
        save_solution(dataset_path, algorithm_choice, cut_off_time, seed = None, solution = solution)
        save_trace(dataset_path, algorithm_choice, cut_off_time, seed = None, trace = trace)
